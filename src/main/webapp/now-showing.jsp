        ...
        <div class="now-showing-list">
            <div class="col-md-4 movies-by-category">
                ...
                <div class="search-by-lang">
                    <div class="c-lang">
                        <input type="checkbox" id="c1" name="cc" />
                        <label class="lang">All Genres</label>
                        <div class="c-lang">
                            <input type="checkbox" id="c1" name="cc" />
                            <label class="lang">Adventure</label>
                        </div>
                        <div class="c-lang">
                            <input type="checkbox" id="c1" name="cc" />
                            <label class="lang">Comedy</label>
                        </div>
                        <div class="c-lang">
                            <input type="checkbox" id="c1" name="cc" />
                            <label class="lang">Drama</label>
                        </div>
                        <div class="c-lang">
                            <input type="checkbox" id="c1" name="cc" />
                            <label class="lang">Horror</label>
                        </div>
                        <div class="c-lang">
                            <input type="checkbox" id="c1" name="cc" />
                            <label class="lang">Romance</label>
                        </div>
                        <div class="c-lang">
                            <input type="checkbox" id="c1" name="cc" />
                            <label class="lang">Sci-FiThriller</label>
                        </div>
                    </div>
            ...
            <div class="col-md-8 movies-now-playing">
                ...
                <div class="col-md-6 movie-preview">
                    <a href="movie-single.html" class="mask">
                        ...
                        <div class="m-movie-title">
                            <a class="m-movie-link" href="movie-single.html">ABCD 2 (3D) (U)</a>
                            <div class="clearfix"></div>
                            <div class="m-r-date">
                                <p><i class="fa fa-calendar-o"></i>19 Jun, 2015</p>
                                <a href="movie-select-show.html">book now</a>
        ...
        <div class="now-showing-movies">
            ...
            <div class="col-md-4 movie-preview">
                <a href="movie-single.html" class="mask">
                    ...
                    <div class="m-movie-title">
                        <a class="m-movie-link" href="movie-single.html">Malupu</a>
                        <div class="clearfix"></div>
                        <div class="m-r-date">
                            <p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
                        </div>
