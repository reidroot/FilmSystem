    ...
    <div class="page-settings">
        ...
        <div class="setting pb10">
            <div class="nav-tabs pa">
                ...
                <h class="countinfo fl active">购票记录</h>
            ...
            <div class="contentBox">
                <div class="table" align="center">
                    ...
                    <div class="table-header-group">
                        <ul class="table-row">
                            <li class="table-cell">订单号</li>
                            <li class="table-cell">影片</li>
                            <li class="table-cell">座位信息</li>
                            <li class="table-cell">总价</li>
                            <li class="table-cell">下单时间</li>
                        </ul>
                    </div>
                    <div class="table-row-group">
                        <c:forEach items="${userOrders}" var="order">
                        <ul class="table-row">
                            <li class="table-cell">${order.orderNum}</li>
                            <li class="table-cell">${order.orderSchedule.scheduleFilm.filmName}</li>
                            <li class="table-cell">${order.position}</li>
                            <li class="table-cell">${order.amount}</li>
                            <li class="table-cell"><fmt:formatDate value="${order.orderTime}" pattern="yyyy-MM-dd HH:mm:ss" /></li>
                        </ul>
                        </c:forEach>
                    </div>
                </div>
