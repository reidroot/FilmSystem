...
<html>
<head>
    <title>Trailers-Now-Showing</title>
...
<div class="container">
    <div class="main-content">
        ...
        <ol class="breadcrumb">
            <li><a href="index.html">Home</a></li>
            <li class="active">Latest Movie Trailers</li>
        </ol>
        <!----->
        <div class="trailers-now-showing">
            <h3>Trailers-Now-Showing</h3>
            <div class="trailers-now-showing-grids">
                <div class="col-md-2 trailers-now-showing-grid text-center">
                    <a href="movie-single.html"><img src="images/200x300.jpg" alt="" /></a>
                    <a class="t-n-s-more" href="movie-single.html">read more</a>
                    <a class="t-n-s-m" href="movie-single.html">Lorem Ipsum Dolor Set (Langusge) (U/A)</a>
                </div>
                <div class="col-md-2 trailers-now-showing-grid text-center">
                    <a href="movie-single.html"><img src="images/200x300.jpg" alt="" /></a>
                    <a class="t-n-s-more" href="movie-single.html">read more</a>
